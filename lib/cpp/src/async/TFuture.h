...
class TBaseController {
 public:
  TBaseController() : has_success_(false), has_error_(false), executed_(false) { }
  TBaseController(success_constref_t success) : has_success_(true), has_error_(false), executed_(false)  { result_.success = success; }
  TBaseController(const result_t& result) : has_success_(false), has_error_(true), executed_(false), result_(result) { }
  ~TBaseController() {
  }
